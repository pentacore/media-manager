            ...
            <CardContent>
                ...
                >
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="url" v-model="serviceUrl" name="url" :placeholder="placeholders.url" />
                        <InputError :message="errors.url" />
                    </div>

                    <div class="space-y-2">
                        <Label for="api_key">API Key</Label>
                        <Input id="api_key" v-model="apiKey" name="api_key" type="password" :placeholder="placeholders.apiKey" />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex gap-2">
                            <Input id="webhook_token" v-model="webhookToken" name="webhook_token" :type="tokenVisible ? 'text' : 'password'" placeholder="Token for webhook authentication" />
