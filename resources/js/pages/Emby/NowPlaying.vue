                    ...
                    <div class="text-sm">
                        ...
                        >
                            ...
                            {{ session.client ?? '-'
                                ...
                                >&nbsp;&middot; {{ session.device_name }}</span
                            >
                        </p>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            <div
                                ...
                                :style="{
                                    width: `${progressPercent(session.play_state?.position_ticks ?? null, session.now_playing?.run_time_ticks ?? null)}%`,
                                }"
                            />
                        </div>
                        <p
                        ...
                        >
                            {{
                                progressPercent(
                                    session.play_state?.position_ticks ?? null,
                                    session.now_playing?.run_time_ticks ?? null,
                                ).toFixed(0)
                            }}%
                        </p>
                    </div>
