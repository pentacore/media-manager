    ...
    <div class="space-y-6 p-6">
        ...
        >
            ...
            <p class="text-lg font-medium">
                Search across Sonarr, Radarr, and Seerr
            </p>
        ...
        <section v-if="results.series.length > 0" class="space-y-3">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card
                    v-for="(series, index) in results.series"
                    :key="`series-${series.tvdb_id ?? index}`"
                >
                    <CardHeader>
        ...
        <section v-if="results.movies.length > 0" class="space-y-3">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card
                    v-for="(movie, index) in results.movies"
                    :key="`movie-${movie.tmdb_id ?? index}`"
                >
                    <CardHeader>
                        <div class="flex gap-3">
                            <div
        ...
        <section v-if="results.requests.length > 0" class="space-y-3">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                <Card
                    v-for="(request, index) in results.requests"
