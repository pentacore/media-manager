        ...
        'model-settings' => [
            IndexedSeries::class => [
                'collection-schema' => [
                    'fields' => [
                        ['name' => 'id', 'type' => 'string'],
                        ['name' => 'service_connection_id', 'type' => 'int32', 'facet' => true],
                        ['name' => 'sonarr_id', 'type' => 'int32'],
                        ['name' => 'tvdb_id', 'type' => 'int32', 'optional' => true],
                        ['name' => 'title', 'type' => 'string'],
                        ['name' => 'sort_title', 'type' => 'string', 'sort' => true, 'optional' => true],
                        ['name' => 'year', 'type' => 'int32', 'facet' => true, 'sort' => true, 'optional' => true],
                        ['name' => 'title_slug', 'type' => 'string', 'index' => false, 'optional' => true],
                        ['name' => 'status', 'type' => 'string', 'facet' => true, 'optional' => true],
                        ['name' => 'monitored', 'type' => 'bool', 'facet' => true],
                        ['name' => 'network', 'type' => 'string', 'facet' => true, 'optional' => true],
                ...
                'search-parameters' => [
                    'query_by' => 'title,sort_title,overview',
            ...
            IndexedMovie::class => [
                'collection-schema' => [
                    'fields' => [
                        ['name' => 'id', 'type' => 'string'],
                        ['name' => 'service_connection_id', 'type' => 'int32', 'facet' => true],
                        ['name' => 'radarr_id', 'type' => 'int32'],
                        ['name' => 'tmdb_id', 'type' => 'int32', 'optional' => true],
                        ['name' => 'imdb_id', 'type' => 'string', 'index' => false, 'optional' => true],
                        ['name' => 'title', 'type' => 'string'],
                        ['name' => 'sort_title', 'type' => 'string', 'sort' => true, 'optional' => true],
                        ...
                        ['name' => 'status', 'type' => 'string', 'facet' => true, 'optional' => true],
                        ['name' => 'monitored', 'type' => 'bool', 'facet' => true],
                        ['name' => 'has_file', 'type' => 'bool', 'facet' => true],
                        ['name' => 'genres', 'type' => 'string[]', 'facet' => true, 'optional' => true],
                        ['name' => 'overview', 'type' => 'string', 'optional' => true],
                        ['name' => 'poster_url', 'type' => 'string', 'index' => false, 'optional' => true],
                        // num_dim must match App\Services\Search\LibraryEmbedder::DIMENSIONS (256).
                ...
                'search-parameters' => [
                    'query_by' => 'title,sort_title,original_title,overview',
                    'query_by_weights' => '4,3,3,1',
