...
| --- | --- |
| app/Services/Actions/** | .ai/rules/actions.md |
...
| database/factories/*.php | .ai/rules/factories.md |
...
| database/seeders/*.php | .ai/rules/seeders.md |
| app/Services/** | .ai/rules/services.md |
| app/Settings/*.php | .ai/rules/settings.md |
